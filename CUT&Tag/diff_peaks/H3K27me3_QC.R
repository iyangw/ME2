setwd("/data/wangyy/CUT_Tag/reanalysis/11_chipqc/H3K27me3")
...
H3K27me3 <- ChIPQC(samples, annotation=annotation, chromosomes = NULL) 
ChIPQCreport(H3K27me3, reportName="ChIP QC report H3K27me3", reportFolder="report")
